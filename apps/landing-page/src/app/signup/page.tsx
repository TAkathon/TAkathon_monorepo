  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center font-sans antialiased selection:bg-primary selection:text-white overflow-hidden bg-black">
      ...
      <div className="relative w-full max-w-[1200px] h-full lg:h-[700px] bg-black lg:border lg:border-neutral-800 lg:rounded-xl shadow-2xl flex flex-col lg:flex-row overflow-hidden mx-auto my-auto z-10">
        ...
        {/* Left Panel - Mascot */}
        <div className="w-full lg:w-1/2 relative bg-[#050505] overflow-hidden flex items-center justify-center border-b lg:border-b-0 lg:border-r border-neutral-800 min-h-[250px] lg:min-h-0">
          ...
          <div className="absolute bottom-8 left-0 right-0 text-center px-6">
            <h2 className="text-xl font-black text-white tracking-widest uppercase opacity-90">
              Happy to <span className="text-primary">Have You</span>
            </h2>
        ...
        {/* Right Panel - Form */}
        <div className="w-full lg:w-1/2 bg-black relative flex flex-col justify-center px-8 py-4 lg:px-12 lg:py-6 overflow-y-auto">
          {/* Header */}
          <div className="mb-4">
          ...
          <form onSubmit={handleSubmit} className="flex-1 flex flex-col justify-center space-y-4">
            ...
            <div className="space-y-3">
              <div className="group">
                ...
                <div className="relative">
                  <input
                    className="tech-input w-full px-4 py-2 text-sm font-medium rounded-none placeholder-neutral-700"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary btn-3d shadow-button-bevel text-white font-black text-lg tracking-widest py-3 uppercase hover:bg-[#ff7b1a] relative overflow-hidden group mt-2 disabled:opacity-50"
            >
            ...
            {/* Login Link */}
            <div className="flex justify-center items-center text-[10px] font-bold tracking-wide py-1">
              <Link href="/login" className="text-white hover:text-primary transition-colors flex items-center gap-2 group">
                ALREADY ON TAKATHON? <span className="text-primary group-hover:translate-x-1 transition-transform">LOGIN</span>
              </Link>
            </div>
          </form>
        </div>
