...
const userSteps = [
    {
        ...
        description: "Sign up and fill in your skills, experience level, and availability.",
    },
    {
        icon: ClipboardCheck,
        title: "Join a Hackathon",
        description: "Browse upcoming hackathons and register for the ones that interest you.",
    },
    {
        icon: Users,
        title: "Build Your Team",
        description: "Invite friends or get AI-powered teammate suggestions to fill open spots.",
    },
    {
        icon: Zap,
        title: "Compete & Win",
        description: "Collaborate with your balanced team and bring your best ideas to life.",
    },
];
...
const organizerSteps = [
    {
        ...
        description: "Set up your hackathon with details, rules, dates, and team requirements.",
    },
    {
        icon: BarChart3,
        title: "Track Registrations",
        description: "View participants, skill distributions, and team formation progress in real-time.",
    },
    {
        icon: Trophy,
        title: "Manage Judging",
        description: "Structured scoring system replaces the chaos of spreadsheets and manual tallying.",
    },
    {
        icon: Share2,
        title: "Export & Analyze",
        description: "Export team data, results, and analytics for sponsors and post-event reports.",
    },
];
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
                ...
                >
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                        How{" "}
                        <span className="text-primary">TAKATHON</span>{" "}
                        Works
                    </h2>
