                    ...
                    <div className="flex-1 space-y-10">
                        ...
                        {activeTab === "SECURITY" && (
                            <div className="relative p-8 bg-[#080808] border border-white/5 rounded-sm">
                                ...
                                <div className="flex items-center gap-4 mb-8 pb-4 border-b border-white/5">
                                    <h2 className="text-lg font-black text-white italic tracking-tighter uppercase">SECURITY SETTINGS</h2>
                                </div>

                                <div className="space-y-6">
                                    <div className="flex items-center justify-between p-5 bg-white/[0.02] border border-white/5 rounded-sm">
                                        <div>
                                            <p className="text-xs font-black text-white uppercase tracking-wider mb-1">CHANGE PASSWORD</p>
                                            <p className="text-[10px] text-white/40 font-bold">Update your access key for enhanced security.</p>
                                        </div>
                                        <button onClick={() => toast.success('A password reset link has been dispatched to your email.')} className="px-6 py-2 bg-transparent border border-primary/30 text-primary text-[10px] font-bold uppercase tracking-widest hover:bg-primary/5 hover:border-primary transition-all active:scale-[0.98] rounded-sm">
                                            UPDATE
                                        </button>
                                    </div>
                                    <div className="flex items-center justify-between p-5 bg-white/[0.02] border border-white/5 rounded-sm">
                                        <div>
                                            <p className="text-xs font-black text-white uppercase tracking-wider mb-1">TWO-FACTOR AUTHENTICATION</p>
                                            <p className="text-[10px] text-white/40 font-bold">Add an extra layer of defense to your account.</p>
                                        </div>
                                        <button onClick={() => toast.info('Initiating 2FA synchronization protocols...')} className="px-6 py-2 bg-transparent border border-primary/30 text-primary text-[10px] font-bold uppercase tracking-widest hover:bg-primary/5 hover:border-primary transition-all active:scale-[0.98] rounded-sm">
                                            ENABLE
                                        </button>
                                    </div>
                                </div>
