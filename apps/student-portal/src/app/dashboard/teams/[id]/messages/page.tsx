...
const PLACEHOLDER_MESSAGES = [
  ...
  },
  {
    ...
    role: "member",
    content:
      "Great! I'm thinking we should start with the backend API design first.",
    time: "1 hour ago",
    isMe: false,
  },
  {
    ...
    role: "member",
    content:
      "Agreed. I can handle the frontend components once the API contract is defined.",
    time: "45 min ago",
    isMe: true,
  },
  {
        ...
        <div className="glass rounded-xl flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-4">
            ...
            {PLACEHOLDER_MESSAGES.map((msg) => (
              ...
              >
                {/* Avatar */}
                <div
                  className={`w-9 h-9 rounded-full flex-shrink-0 flex items-center justify-center text-sm font-bold ${msg.isMe ? "bg-primary/30 text-primary" : "bg-white/10 text-white"}`}
                >
                  {msg.initials}
                </div>
                ...
                {/* Bubble */}
                <div
                  className={`max-w-[70%] ${msg.isMe ? "items-end" : "items-start"} flex flex-col gap-1`}
                >
                  {!msg.isMe && (
          ...
          <div className="border-t border-white/10 p-4">
            ...
            <p className="text-center text-white/25 text-xs mt-2">
              Real-time messaging with WebSockets will be available in a future
              release.
            </p>
          </div>
        </div>
