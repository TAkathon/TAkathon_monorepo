...
export default function SponsorDashboard() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([profileRes, sponsorshipsRes]) => {
        ...
        const sps =
          sponsorshipsRes.data.data?.sponsorships ||
          sponsorshipsRes.data.data ||
          [];
  ...
  const stats = [
    ...
    },
    {
      ...
      value: pendingSponsorships.length.toString(),
      icon: Clock,
      color: "text-amber-400",
    },
    {
      name: "Total Invested",
      value: totalAmount > 0 ? `$${totalAmount.toLocaleString()}` : "$0",
      icon: DollarSign,
      color: "text-blue-400",
    },
  ];
  ...
  const companyName =
    profile?.companyName || profile?.user?.fullName || "Sponsor";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="glass rounded-2xl p-6 bg-gradient-to-br from-primary/10 to-transparent border-primary/20">
                ...
                <p className="text-xs text-white/40">
                  Across {sponsorships.length} sponsorships
                </p>
              </div>
            </div>
          </div>
