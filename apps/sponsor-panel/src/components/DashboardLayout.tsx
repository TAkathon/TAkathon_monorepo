...
export default function DashboardLayout({
  ...
  if (!_hasHydrated || !isAuthenticated || (user?.role && user.role !== "sponsor")) {
    return (
            ...
            <div className="flex items-center gap-4">
              <div className="relative" ref={bellRef}>
                ...
                >
                  ...
                  {unreadCount > 0 && (
                    <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-primary rounded-full border-2 border-black shadow-glow-sm" />
                  )}
                </button>
