...
const navigation = [
    { name: "HQ Overview", href: "/", icon: LayoutDashboard },
    { name: "Operations", href: "/hackathons", icon: Trophy },
    { name: "Applicants", href: "/participants", icon: Users },
    { name: "Squad Depot", href: "/teams", icon: Users },
    { name: "Mission Intake", href: "/applications", icon: FileText },
    { name: "Rankings", href: "/leaderboard", icon: Trophy },
    { name: "Intel Dashboard", href: "/analytics", icon: BarChart },
    { name: "Signal Alerts", href: "/notifications", icon: Bell },
